...
T = {
    "uz": {
        ...
        "order_success": (
            ...
            "Tez orada @vita\\_deluxe bog'lanadi. 📞\n\nBoshqa savol: /start"
        ),
        ...
        "ugc_success": (
            ...
            "Tez orada @vita\\_deluxe siz bilan bog'lanadi.\n\n"
            "Boshqa savol: /start"
        ),
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    data = query.data
    if data == "back_main":
        await query.edit_message_text(t(context, "choose_section"), reply_markup=main_menu(context))
    elif data == "faq":
        await query.edit_message_text(t(context, "faq_title"), parse_mode="Markdown", reply_markup=faq_menu(context))
    elif data.startswith("faq_"):
        await query.edit_message_text(t(context, data), parse_mode="Markdown", reply_markup=back_faq_kb(context))

async def order_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    await query.edit_message_text(t(context, "order_ask_name"), parse_mode="Markdown", reply_markup=cancel_kb(context))
    return NAME
...
async def order_get_phone(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(t(context, "order_ask_package"), parse_mode="Markdown", reply_markup=package_kb(context))
    return PACKAGE
...
async def ugc_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    await query.edit_message_text(t(context, "ugc_welcome"), parse_mode="Markdown", reply_markup=ugc_start_kb(context))
    return UGC_NAME

async def ugc_begin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    await query.edit_message_text(t(context, "ugc_ask_name"), parse_mode="Markdown", reply_markup=ugc_cancel_kb(context))
    return UGC_NAME

async def ugc_get_name(update: Update, context: ContextTypes.DEFAULT_TYPE):
    context.user_data["ugc_name"] = update.message.text
    await update.message.reply_text(t(context, "ugc_ask_age"), parse_mode="Markdown", reply_markup=ugc_cancel_kb(context))
    return UGC_AGE

async def ugc_get_age(update: Update, context: ContextTypes.DEFAULT_TYPE):
    context.user_data["ugc_age"] = update.message.text
    await update.message.reply_text(t(context, "ugc_ask_city"), parse_mode="Markdown", reply_markup=ugc_cancel_kb(context))
    return UGC_CITY

async def ugc_get_city(update: Update, context: ContextTypes.DEFAULT_TYPE):
    context.user_data["ugc_city"] = update.message.text
    await update.message.reply_text(t(context, "ugc_ask_instagram"), parse_mode="Markdown", reply_markup=ugc_cancel_kb(context))
...
async def ugc_get_instagram(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(t(context, "ugc_ask_phone"), parse_mode="Markdown", reply_markup=ugc_cancel_kb(context))
    return UGC_PHONE
...
async def fallback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    lang = context.user_data.get("lang", "uz")
    await update.message.reply_text(T[lang]["fallback"])
